public class DividenConquer {
    ...
    public static void merge1(int arr[], int si, int mid, int ei){
        int temp[] = new int[ei - si +1];
        int i = si;
        int j = mid+1;
        int k = 0;
    ...
    public static void main(String[] args) {
        ...
        int ei = arr.length-1;
        mergeSort(arr, si, ei);
        System.out.print("Merged using Method 1: ");
        printArr(arr);
        System.out.println();
        
        int arr1[] = {4,5,9,1,11};
        int si1 = 0;
        int ei1= arr1.length-1;
        mergeSort1(arr1, si1, ei1);
        System.out.print("Merged using Method 2: ");
        printArr(arr1);
        System.out.println();
    }
}
